...
/*
 * The OPENSSL_NO_* macros are also defined as NO_* if the application asks
 * for it.  This is a transient feature that is provided for those who
 * haven't had the time to do the appropriate changes in their applications.
 *
 */
...
#  endif
/*
 * These default values were supplied by Peter Gutman
 * <pgut001@cs.auckland.ac.nz> They are only used if nothing else has been
 * defined
 */
