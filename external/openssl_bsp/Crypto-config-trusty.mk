...
common_c_includes := \
  external/openssl_bsp/. \
  external/openssl_bsp/crypto \
  external/openssl_bsp/crypto/asn1 \
  external/openssl_bsp/crypto/evp \
  external/openssl_bsp/crypto/modes \
  external/openssl_bsp/include \
  external/openssl_bsp/include/openssl \
